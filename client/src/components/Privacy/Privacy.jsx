...
import NoFlashcardlyHeader from '../Header/NoFlashcardlyHeader.jsx';
						...
						<div className="flashcards_block">
							...
							<div className="flashcards_block_body">
								<div className="privacy_body">
									...
									<h2>Use of Data</h2>
									<p>Flashcardly uses the collected data for various purposes:</p>
									<ul>
									...
									<p>Flashcardly will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
									<h2>Disclosure Of Data</h2>
									<h3>Legal Requirements</h3>
									<p>Flashcardly may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
									<ul>
										<li>To comply with a legal obligation</li>
										<li>To protect and defend the rights or property of Flashcardly</li>
									...
									<h2>Contact Us</h2>
									<p>If you have any questions about this Privacy Policy, please contact us: <b>cezary.goralski@onet.pl</b></p>
								</div>
							</div>
						</div>
					</div>
